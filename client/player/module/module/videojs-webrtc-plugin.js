/*! @name @antmedia/videojs-webrtc-plugin @version 1.2.0 @license MIT */
(function (global, factory) {
    ...
    (function (global, factory) {
          ...
          */
          ...
          this.wsConn.onmessage = function (event) {
            ...
            if (obj.command == "start") {
              ...
              _this.webrtcadaptor.startPublishing(obj.streamId);
              ...
              _this.callbackError(obj.definition, obj);
              ...
              _this.multiPeerStreamId = obj.streamId;

              _this.join(obj.streamId);
      ...
      var SoundMeter = /*#__PURE__*/function () {
        ...
        _proto2.connectToSource = function connectToSource(stream, levelCallback, errorCallback) {
          ...
          return this.context.audioWorklet.addModule(new URL('./volume-meter-processor.js', typeof document === 'undefined' && typeof location === 'undefined' ? commonjsRequire().pathToFileURL(__filename).href : typeof document === 'undefined' ? location.href : document.currentScript && document.currentScript.src || new URL('webrtc_adaptor.js', document.baseURI).href)).then(function () {
            _this3.mic = _this3.context.createMediaStreamSource(stream);
            _this3.volumeMeterNode = new AudioWorkletNode(_this3.context, 'volume-meter');

            _this3.volumeMeterNode.port.onmessage = function (event) {
              if (event.data.type == 'debug') {
                console.debug(event.data.message);
              } else {
                _this3.instant = event.data;
                levelCallback(_this3.instant.toFixed(2));
                console.debug("Audio level: " + _this3.instant.toFixed(2));
              }
            };

            _this3.mic.connect(_this3.volumeMeterNode);
          }).catch(function (err) {
      ...
      var MediaManager = /*#__PURE__*/function () {
        ...
        _proto3.enableAudioLevelWhenMuted = function enableAudioLevelWhenMuted() {
          ...
          navigator.mediaDevices.getUserMedia({
            ...
            _this13.mutedSoundMeter = new SoundMeter(_this13.audioContext);
        ...
        _proto3.enableAudioLevelForLocalStream = function enableAudioLevelForLocalStream(levelCallback) {
          var _this21 = this;
          ...
          if (this.audioContext.state !== 'running') {
            return this.audioContext.resume().then(function () {
              return _this21.localStreamSoundMeter.connectToSource(_this21.localStream, levelCallback);
            });
          } else {
        ...
        _proto3.disableAudioLevelForLocalStream = function disableAudioLevelForLocalStream() {
          if (this.localStreamSoundMeter != null) {
      ...
      var WebRTCAdaptor = /*#__PURE__*/function () {
        ...
        _proto4.publish = function publish(streamId, token, subscriberId, subscriberCode, streamName, mainTrack, metaData) {
          ...
          setTimeout(function () {
            ...
            if (_this25.iceConnectionState(_this25.publishStreamId) != "checking" && _this25.iceConnectionState(_this25.publishStreamId) != "connected" && _this25.iceConnectionState(_this25.publishStreamId) != "completed") {
        ...
        _proto4.play = function play(streamId, token, roomId, enableTracks, subscriberId, subscriberCode, metaData) {
          ...
          setTimeout(function () {
            //check if it is connected or not
            //this resolves if the server responds with some error message
            if (_this26.iceConnectionState(streamId) != "checking" && _this26.iceConnectionState(streamId) != "connected" && _this26.iceConnectionState(streamId) != "completed") {
              //if it is not connected, try to reconnect
        ...
        _proto4.tryAgain = function tryAgain() {
          ...
          for (var index in this.playStreamId) {
            ...
            if (this.remotePeerConnection[streamId] != "null" && //check connection status to not stop streaming an active stream
          ...
          if (this.remotePeerConnection[streamId] == null) {
            ...
            this.remotePeerConnection[streamId].oniceconnectionstatechange = function (event) {
              ...
              if (obj.state == "failed" || obj.state == "disconnected" || obj.state == "closed") {
                _this29.reconnectIfRequired(3000);
              }
        ...
        _proto4.disableAudioLevelForLocalStream = function disableAudioLevelForLocalStream() {
  ...
  var WebRTCHandler = /*#__PURE__*/function () {
    ...
    _proto.initiateWebRTCAdaptor = function initiateWebRTCAdaptor(source, options) {
      ...
      let splitSource = source.src.split('/');

      this.source.mediaServerUrl = source.src.replace(splitSource[splitSource.length - 1], 'websocket');
      let lastPart = splitSource[splitSource.length - 1];
      this.source.streamName = lastPart.split('.webrtc')[0];
