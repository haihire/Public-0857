...
**프로젝트 기간**: 2024.01 ~ 2024.07

## 프로젝트 개요 (Project Overview)

멀티 호스트 기반 실시간 룸 서버 아키텍처를 설계·구현하고 서버를 기능별로 모듈화하여 후속 개발 기간을 약 50% 단축했습니다.

*Designed and implemented a multi-host based real-time room server architecture, modularized servers by function, and reduced subsequent development time by approximately 50%.*
